...
function checkInputs() {
  ...
  if ( $('#name-field input').val() != '' && $('#calories-field input').val() != '') {
    ...
    // $('tbody').prepend('<tr class="food-row"><td class="food-name">' + food + '</td><td class="food-calories">' + calories + '</td><td class="food-delete"><button>-</button></td></tr>');
...
function foodTableSingleRow(name, calories, deleteButton, checkBox, addToList){
  ...
  oneRowHtml += '</tr>';
  // $('tbody').prepend('<tr class="food-row"><td class="food-name">' + name + '</td><td class="food-calories">' + calories + '</td><td class="food-delete"><button>-</button></td></tr>');
  if (addToList) {
...
function loadFoodList(){
  ...
  if (foods != null) {
    foods.forEach(function(oneFood){
      // $('tbody').append('<tr class="food-row"><td class="food-name">' + oneFood.name + '</td><td class="food-calories">' + oneFood.calories + '</td><td class="food-delete"><button>-</button></td></tr>');    
